...
int main()
{
    ...
    string stockNames[] = {"Coca Cola", "Amazon", "Rockstar", "Google", "Tata"};
    int price[] = {450, 1300, 760, 1230, 670};

    //Objects
    Investment::DematAccount DematAC;
    Investment::StockMarket stockmarket(stockNames, price);
    //Vars
    int ch;
    //Loading Data (Some classes automatically saves their data)
    loadData();
    Investment::loadData(DematAC);
    while(1)
    {
